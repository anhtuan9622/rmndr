...
Revision ID: 3ebf6bce9b46
Revises: 3523ff06b641
Create Date: 2019-12-02 01:25:24.658714
...
revision = '3ebf6bce9b46'
down_revision = '3523ff06b641'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('task_due', sa.String(length=128), nullable=True),
    sa.Column('task_remind', sa.String(length=128), nullable=True),
